...
<title>${siteName!""}|教职工管理-添加教职工</title>
    ...
    <main class="lyear-layout-content">
      ...
      <div class="container-fluid">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="card">
              <div class="card-header"><h4>添加教职工</h4></div>
              <div class="card-body">
                <form action="add" id="coach-add-form" method="post" class="row">

                  <div class="input-group m-b-10">
                    <span class="input-group-addon">教职工名</span>
                    <input type="text" class="form-control required" id="name" name="name" value="" placeholder="请输入教职工名" tips="请填写教职工名" />
                  </div>
	...
	$("#add-form-submit-btn").click(function(){
		...
		$.ajax({
			...
			success:function(data){
				if(data.code == 0){
					showSuccessMsg('教职工添加成功!',function(){
